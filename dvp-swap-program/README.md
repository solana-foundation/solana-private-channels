...
| 10   | `BlockedMintExtension`        | Create with a Token-2022 mint carrying an unsupported extension (TransferFee, ConfidentialTransferFeeConfig, InterestBearing, ScaledUiAmount, NonTransferable) |
