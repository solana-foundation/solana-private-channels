...
use crate::error::ContraSwapProgramError;
...
pub fn validate_mint_extensions(mint_info: &AccountView) -> ProgramResult {
    ...
    let mint = StateWithExtensions::<Token2022MintState>::unpack(&data)
        .map_err(|_| ContraSwapProgramError::BlockedMintExtension)?;
    ...
    {
        return Err(ContraSwapProgramError::BlockedMintExtension.into());
    }
