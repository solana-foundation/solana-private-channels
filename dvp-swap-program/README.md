...
SwapDvp {
    ...
    settlement_destination_a: Pubkey,            // receives the cash leg at Settle (defaults to user_a)
    settlement_destination_b: Pubkey,            // receives the asset leg at Settle (defaults to user_b)
